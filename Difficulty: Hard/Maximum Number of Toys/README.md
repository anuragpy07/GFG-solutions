<h2><a href="https://www.geeksforgeeks.org/problems/maximum-number-of-toys/1?page=5&difficulty=Hard&sortBy=submissions">Maximum Number of Toys</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given <strong>N</strong> toys&nbsp;in a shop&nbsp;.<br>
